...
{
    public interface IVisitorBusiness
    {
        #region CRUD Basic
        ...
        /// </summary>
        /// <returns></returns>
        ICollection<Visitor> GetAllWithoutPagination();
        ...
        /// <returns></returns>
        ICollection<Visitor> GetAllWithPagination(SearchViewModel searchView);
        ...
        /// <returns>ServiceResponeCode</returns>
        Task<ServiceResponeCode> UpdateAsync(int id, Visitor entityToUpdate);
        ...
        /// <param name="entityToUpdate"></param>
        /// <returns>ServiceResponeCode</returns>
        Task<ServiceResponeCode> CreateAsync(Visitor entityToCreate);
