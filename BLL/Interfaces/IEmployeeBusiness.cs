...
namespace Bll.Interfaces
{
    public interface IEmployeeBusiness
    {
        ...
        /// </summary>
        /// <returns></returns>
        ICollection<Employee> GetAllWithoutPagination();
        ...
        /// <returns></returns>
        ICollection<Employee> GetAllWithPagination(SearchViewModel searchView);
        ...
        /// <returns>ServiceResponeCode</returns>
        Task<ServiceResponeCode> UpdateAsync(int id, Employee entityToUpdate);
        ...
        /// <param name="entityToUpdate"></param>
        /// <returns>ServiceResponeCode</returns>
        Task<ServiceResponeCode> CreateAsync(Employee entityToCreate);
