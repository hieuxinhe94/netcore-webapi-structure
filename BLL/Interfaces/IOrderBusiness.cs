...
namespace Bll.Interfaces
{
    public interface IOrderBusiness
    {
        ...
        /// </summary>
        /// <returns></returns>
        ICollection<Order> GetAllWithoutPagination();
        ...
        /// <returns></returns>
        ICollection<Order> GetAllWithPagination(SearchViewModel searchView);
        ...
        /// <returns>ServiceResponeCode</returns>
        Task<ServiceResponeCode> UpdateAsync(int id, Order entityToUpdate);
        ...
        /// <param name="entityToUpdate"></param>
        /// <returns>ServiceResponeCode</returns>
        Task<ServiceResponeCode> CreateAsync(Order entityToCreate);
